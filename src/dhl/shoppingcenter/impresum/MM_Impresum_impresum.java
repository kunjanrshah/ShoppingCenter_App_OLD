...
import dhl.shoppingcenter.main_menu_info.MM_INFO_Fundburo;
...
public class MM_Impresum_impresum extends Activity implements OnClickListener{
	private Button btn_Home = null, btn_Back = null;
	private CommonClass mClass = null;
	private static final String ACTION = "impressum";
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if( mClass.CheckNetwork(this)){
			new get_FullDescription_Impresum().execute(Constant.GETTING);
		}
	}
	/*******************************************************************************************************/
	private void getBundleData(){
		TextView tvTitlebar_title = (TextView)findViewById(R.id.txt_titleBar_displayIn);
		Bundle mBundle = getIntent().getExtras();
		if( mBundle != null){
			tvTitlebar_title.setText( mBundle.getString(Constant.BUNDLE_IMPRESUM).toString() );
		}
	}
	/*******************************************************************************************************/
	...
	public void onClick(View v) {
		if( v == btn_Home ){
			Intent in = new Intent(MM_Impresum_impresum.this, MainMenu_Activity.class);
	...
	private void sendMail(){
		if(mClass.CheckNetwork(MM_Impresum_impresum.this)){
			try{
	...
	private class get_FullDescription_Impresum extends AsyncTask<String, String, String>{
		protected void onPreExecute() {
			mProcessDialog = new ProcessDialog(MM_Impresum_impresum.this, Constant.GETTING, Constant.LOADING);
			super.onPreExecute();
		}
