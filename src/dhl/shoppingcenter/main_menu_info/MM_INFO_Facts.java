...
public class MM_INFO_Facts extends Activity implements OnClickListener{
	...
	private static final String ACTION = "info_facts";
	
	protected void onCreate(Bundle savedInstanceState) {
		
		super.onCreate(savedInstanceState);
		setRequestedOrientation(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.xinfo_facts);
		
		getBasicInfo();
		
		if( mClass.CheckNetwork(MM_INFO_Facts.this)){
	...
	public void onClick(View v) {
		if( v == btn_Home ){
			Intent in = new Intent(MM_INFO_Facts.this, MainMenu_Activity.class);
	...
	private class get_FullDescription_Facts extends AsyncTask<String, String, String>{
		protected void onPreExecute() {
			mProcessDialog = new ProcessDialog(MM_INFO_Facts.this, Constant.GETTING, Constant.LOADING);
			super.onPreExecute();
		}
