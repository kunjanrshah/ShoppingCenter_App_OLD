...
public class MM_INFO_Geschenkgutscheine extends Activity implements OnClickListener{
	...
	private static final String ACTION = "info_geschenkgutscheine";
	
	protected void onCreate(Bundle savedInstanceState) {
	
		super.onCreate(savedInstanceState);
		requestWindowFeature(Window.FEATURE_NO_TITLE);
		setContentView(R.layout.xinfo_geschenkgut);
	
		getBasicInfo();
		
		if( mClass.CheckNetwork(MM_INFO_Geschenkgutscheine.this)){
			new get_FullDescription_Geschen().execute(Constant.GETTING);
		}
	}
	...
	public void onClick(View v) {
		if( v == btn_Home ){
			Intent in = new Intent(MM_INFO_Geschenkgutscheine.this, MainMenu_Activity.class);
	...
	private class get_FullDescription_Geschen extends AsyncTask<String, String, String>{
		protected void onPreExecute() {
			mProcessDialog = new ProcessDialog(MM_INFO_Geschenkgutscheine.this, Constant.GETTING, Constant.LOADING);
			super.onPreExecute();
		}
